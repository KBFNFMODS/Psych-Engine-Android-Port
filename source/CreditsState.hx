...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['KNFNFMODS',		'shadowmario',		'Main Coder And Porter',					'https://twitter.com/Shadow_Mario_',	'0xFFFFDD33'],
			['NerySonicAwesome',			'riveroaken',		'Helper AMD Collaboration',				'https://twitter.com/river_oaken',		'0xFFC30085'],
			[''],
			['Engine Contributors'],
